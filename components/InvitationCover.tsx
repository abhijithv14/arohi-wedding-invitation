  ...
  return <AnimatePresence>{visible && <motion.div initial={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 1.4, ease: "easeInOut" }} className="fixed inset-0 z-[100] overflow-hidden bg-[#2A211D]">
    ...
    {opening && <div className="pointer-events-none fixed inset-0 z-40 overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center">
        <motion.div initial={{ opacity: 0, scale: 0.72 }} animate={{ opacity: [0, 0.7, 0.45, 0], scale: [0.72, 1, 1.08, 1.15] }} transition={{ duration: 2.8, delay: 0.15, ease: "easeOut" }} className="absolute h-32 w-32 sm:h-40 sm:w-40">
          <span className="absolute left-1/2 top-0 h-20 w-12 -translate-x-1/2 rounded-[60%_40%_60%_40%] bg-[#E7BDB2]/60 sm:h-24 sm:w-14" /><span className="absolute left-1 top-1/2 h-20 w-12 -translate-y-1/2 rotate-[-72deg] rounded-[60%_40%_60%_40%] bg-[#E1B2A7]/60 sm:h-24 sm:w-14" /><span className="absolute right-1 top-1/2 h-20 w-12 -translate-y-1/2 rotate-[72deg] rounded-[60%_40%_60%_40%] bg-[#E1B2A7]/60 sm:h-24 sm:w-14" /><span className="absolute bottom-0 left-1/2 h-20 w-12 -translate-x-1/2 rotate-180 rounded-[60%_40%_60%_40%] bg-[#D6A094]/60 sm:h-24 sm:w-14" /><span className="absolute left-1/2 top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#B9795E]/75 sm:h-6 sm:w-6" />
        </motion.div>
        <motion.div initial={{ opacity: 0, scale: 0.88, y: 18 }} animate={{ opacity: [0, 1, 1, 0], scale: [0.88, 1, 1, 1.02], y: [18, 0, 0, -18] }} transition={{ duration: 2.3, times: [0, 0.2, 0.72, 1], ease: "easeInOut" }} className="relative flex flex-col items-center"><div className="font-serif text-7xl font-light tracking-[-0.12em] text-[#704636] sm:text-8xl">AR</div><span className="mt-3 h-px w-14 bg-[#9A654D]/70" /><div className="mt-5 font-serif text-2xl font-light tracking-wide text-[#5D4034] sm:text-3xl">Aparna + Rohit</div></motion.div>
      </div>
